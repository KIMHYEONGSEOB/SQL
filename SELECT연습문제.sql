...
SELECT FIRST_NAME, SALARY, SALARY+300 RAISE FROM EMPLOYEES;
...
SELECT FIRST_NAME||' '||LAST_NAME||'사원의 급여는'||SALARY||'달러 입니다' AS "STEVEN KING" FROM EMPLOYEES WHERE LAST_NAME = 'King' AND FIRST_NAME = 'Steven';
